...
const blogPost = (keyword, lsiKeyword, title, headers, content, previousArticles, imageNames) => {
  ...
  -Blog title: ${title}. \n
  -Use the following headers in for the blog with each being an h2: ${arrayToString(headers)}. \n
...
const blogPostForBlogger = (keyword, lsiKeyword, title, headers, content, previousArticles) => {
  return blogPost(keyword, lsiKeyword, title, headers, content, previousArticles, []);
}
