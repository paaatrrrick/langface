...
const Home = () => {
    ...
    const defualtPills = [
      ...
      },
      {
        ...
        img: StoreFrontSvg,
        content: `An Search Engine Optimized blog post is written and posted to your ${version === 'blogger' ? 'Blogger' : "Wordpress"} account with specific long tail keywords, an optimal HTML header structuren, and more!`,
      }
    ];
