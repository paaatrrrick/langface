...
const HeroOne = ({demoClick}) => {
    return (
            <div class="relative isolate bg-white w-full">
                ...
                <div class="py-32 w-full flex col align-center justify-center px-3 md:flex-row">
                    <div class="flex flex-col align-center justify-start md:justify-between w-full md:flex-row" style={{maxWidth: '1500px'}}>
                        <div className="w-full md:w-2/5">
                            <h1 class="font-semibold tracking-tight text-mainDark-600 text-2xl md:text-4xl lg:text-5xl">Drive organic web traffic with optimized articles</h1>
